...
header = "COMPUTOR V1 TESTS".center(terminal_width, " ")
print(f"\033[32m\033[42m\033[1m{header}\033[0m")
for equation in equations:

    basic_text = f" Testing: {equation} ".center(terminal_width, ".")
    text = f"\033[32m\033[44m\033[1m{basic_text}\033[0m"
    print(text)
    subprocess.run([name, "computor.py", equation])
    print()
